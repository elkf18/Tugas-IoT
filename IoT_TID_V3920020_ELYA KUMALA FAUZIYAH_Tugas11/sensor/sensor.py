...
if sensor == 1:
    ...
    while nilai < nilai_max:
        ...
        input_suhu = suhu, waktu
        tb_suhu.append(input_suhu)
        sq = "insert into "+pilih_sensor+" (Suhu,Waktu) values (%s,%s)"
