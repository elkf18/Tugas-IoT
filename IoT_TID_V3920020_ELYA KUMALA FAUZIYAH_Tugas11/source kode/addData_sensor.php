            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="number" class="form-sensor form-sensor-md w-30" id="sensor1" placeholder="Masukkan suhu" name="sensor1" autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="number" class="form-sensor form-sensor-md w-30" id="sensor2" placeholder="Masukkan kelembapan" name="sensor2" autocomplete="off" required>
                        </div>
                    </div>
